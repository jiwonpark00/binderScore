...
#   --residue-csv      - Target residue CSV file (target_name,residue_number,distance_cutoff)
...
Example:
  $0 --csv input.csv --project project/ --target-dir targets/ \\
     --residue-csv residues.csv --binder-msa false

  $0 --csv input.csv --project project/ --target-dir targets/ \\
     --residue-csv residues.csv --binder-msa true \\
